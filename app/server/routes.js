...
// main login page //
	router.get('/', function(req, res){
		...
		//console.log("ssss--"+req.session.user.email);
...
// view & delete accounts //
	...
	router.get('/deletefiles', function(req, res) {
		rmFiles("/Users/heena.madan/nodejs/uploads");
		console.log("all files deleted");
		res.redirect('/showfiles');	
	});

	rmFiles = function(dirPath) {
    ...
    router.get('/deletefile/:fileid', function(req, res) {
		var fileList = walkSync("/Users/heena.madan/nodejs/uploads",[]);
		rmDir("/Users/heena.madan/nodejs/uploads");
		res.render('showfiles', { title : 'File List', files : fileList });
	});
